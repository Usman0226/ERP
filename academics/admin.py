...
from .models import (
    Department, AcademicProgram, Course, CourseSection, Syllabus, SyllabusTopic, 
...
class DepartmentAdmin(admin.ModelAdmin):
    list_display = ['code', 'name', 'head_of_department', 'is_active', 'get_faculty_count', 'get_course_count']
    ...
    get_faculty_count.short_description = 'Faculty Count'
